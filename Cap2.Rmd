...
For the models relating species-level indices to the reproductive success of each species, we found high collinearity with the variable of total visits received per plant species and therefore excluded this from the models. In the case of Doñana, no variable significantly influenced the reproductive success of the plants. However, in Gorbea, we observed that pollinator species richness (estimate = 4.32, z value = 1.97, p = 0.049) , weighted closeness (estimate = 79.55, z value = 2.2, p = 0.028) and Morisita niche overlap (estimate = 184.12, z value = 2.22, p value = 0.026) increased the reproductive success of the plant species. It was also determined that the positive effect of pollinator richness (estimnate = -1, z value = -1.99, p = 0.047) and weighted closeness (estimate =-16.25, z value = -2.22, p value = 0.026) diminishes throughout the season, thereby exerting a greater influence on the reproductive success of the plants at the onset of the season. Furthermore, the study revealed that reproductive success at the species level remained constant throughout the flowering season at both study sites.

```{r plots_splevel}
load("RData/splevel_repro.RData") 
p.g.sp_final
```
